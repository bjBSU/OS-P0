...
void test_incorrectAdd(void) {
  TEST_ASSERT_EQUAL(0, incorrectAdd(-5, 4));
  TEST_ASSERT_EQUAL(9, incorrectAdd(5, 3));
  TEST_ASSERT_EQUAL(2, incorrectAdd(0, 1));
}
